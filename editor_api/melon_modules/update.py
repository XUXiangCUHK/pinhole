...
class Update:
    ...
    def update_event(self, ts_before, ts_in_min):
        ...
        for event_id in event_id_list:
            ...
            # leaf_content_id_list = self.event_detection.get_leaf(news_collection, news_pool)
